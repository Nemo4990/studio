...
export default function AdminTasksPage() {
  ...
  const initialTasksToSeed = [
    ...
    { id: '2', name: 'Crypto Beginner\'s Quiz', description: 'Test your knowledge on basic crypto concepts. Pass the quiz to earn a reward and learn something new!', reward: 450, requiredLevel: 0, icon: 'https://placehold.co/100x100/transparent/FFFFFF/png?text=Crypto+Quiz' },
    { id: '11', name: 'Speedmath Challenge', description: 'Answer as many questions as you can. Get over 80% to win the reward!', reward: 400, requiredLevel: 0, icon: 'https://placehold.co/100x100/transparent/FFFFFF/png?text=Speedmath' },
    { id: '12', name: 'Memory Pattern Recall', description: 'Memorize and replicate the sequence of patterns. Reach Level 4 to win!', reward: 400, requiredLevel: 0, icon: 'https://placehold.co/100x100/transparent/FFFFFF/png?text=Memory' },
    { id: '13', name: 'Logic Puzzle Solving', description: 'Solve the riddle to prove your wits and earn the reward!', reward: 480, requiredLevel: 0, icon: 'https://placehold.co/100x100/transparent/FFFFFF/png?text=Logic+Puzzle' },
