      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {isLoading || !user ? (
            <>
                ...
                <StatCard title="Tasks Completed" value={<Skeleton className="h-6 w-12 mt-1" />} icon={CheckCircle2} description="Keep up the great work!" />
                <StatCard title="Total Earnings" value={<Skeleton className="h-6 w-20 mt-1" />} icon={BarChart} description="All-time earnings" />
            </>
        ) : (
            <>
