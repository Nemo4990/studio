  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
        <section className="relative flex items-center justify-center py-20 text-center text-white md:py-32">
          {aboutHeroImage && (
            <Image
        ...
        <section className="py-20 md:py-32">
          <div className="container">
            <div className="mx-auto max-w-3xl space-y-8 text-lg text-foreground/80">
              ...
              <h2 className="font-headline text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Our Vision</h2>
              <p>
