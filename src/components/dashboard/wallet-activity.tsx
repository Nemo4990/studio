...
const mockActivities = [
  ...
  { type: 'deposit', name: 'Abebe B.', amount: '3,000 ETB', avatar: 'https://picsum.photos/seed/et1/40/40' },
  { type: 'deposit', name: 'Ken A.', amount: '$100.00', avatar: 'https://picsum.photos/seed/wa3/40/40' },
  { type: 'withdraw', name: 'Liya K.', amount: '1,500 ETB', avatar: 'https://picsum.photos/seed/et2/40/40' },
  ...
  { type: 'deposit', name: 'Dawit S.', amount: '5,000 ETB', avatar: 'https://picsum.photos/seed/et3/40/40' },
  { type: 'deposit', name: 'Michael C.', amount: '$250.00', avatar: 'https://picsum.photos/seed/wa7/40/40' },
  { type: 'withdraw', name: 'Tigist M.', amount: '800 ETB', avatar: 'https://picsum.photos/seed/et4/40/40' },
